...
**Last updated:** 2026-04-11 (P1.94 B31 currency mismatch 150% cap in v0.1.192)
**Package version:** 0.1.192 (pyproject.toml) | **Test suite:** 5,238 selectable (5,238 total, 11 deselected benchmarks)
**Test run (2026-04-11):** 5,206 passed, 21 skipped (conditional fixture guards), 11 deselected (benchmarks)
...
- **P1.94** [x] **FIXED v0.1.192** — B31 currency mismatch 1.5x now capped at 150%. `sa/calculator.py:1796` uses `.clip(upper_bound=1.50)` per Art. 123B. Defaulted retail (150% base) with currency mismatch no longer inflated to 225%. New test `test_currency_mismatch_capped_at_150_pct` validates the cap. **Effort: S** | Ref: PRA PS1/26 Art. 123B
