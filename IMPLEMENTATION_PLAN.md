...
**Last updated:** 2026-04-11 (P1.132 B31 government-supported equity corrected from 100% to 250% per Art. 133(3); Art. 133(6) is exclusion clause not RW)
**Package version:** 0.1.189 (pyproject.toml) | **Test suite:** 5,218 selectable (5,218 total, 11 deselected benchmarks)
