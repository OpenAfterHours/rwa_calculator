...
- **Status:** [~] Partial (OF 02.01, C 08.03, C 08.05, C 08.06, and C 08.07 complete; C 08.04 not started)
- **Templates:**
...
- **Fix remaining:** Add C 08.04 template definitions and generator methods. Add OF 08.05.1/OF 34.07 to `docs/features/corep-reporting.md`.
