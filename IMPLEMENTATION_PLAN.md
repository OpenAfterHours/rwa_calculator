...
**Last updated:** 2026-04-11 (P1.134 B31 unrated covered bond with rated issuer now correctly derives CB RW from ECRA-rated issuer's institution CQS via Art. 129(5))
**Package version:** 0.1.188 (pyproject.toml) | **Test suite:** 5,218 selectable (5,218 total, 11 deselected benchmarks)
**Test run (2026-04-11):** 5,186 passed, 21 skipped (conditional fixture guards), 11 deselected (benchmarks)
