...
Polars namespace extensions for counterparty and facility hierarchy resolution.
...
class HierarchyLazyFrame:
    ...
    def resolve_ultimate_parent(
        ...
        Uses eager graph traversal (collects edge data, resolves via dict
        traversal, joins lookup back onto the calling LazyFrame).
...
Polars namespace extensions for result combination and output floor application.
...
class AggregatorLazyFrame:
    ...
    def combine_approach_results(
        ...
        """Combine SA, IRB, and Slotting results. Adds: approach_applied, rwa_final."""
    ...
    def apply_output_floor(
        ...
        Adds columns: rwa_pre_floor, sa_rwa, floor_rwa,
        output_floor_pct, is_floor_binding, floor_impact_rwa, rwa_final.
        """
    ...
    def generate_summary_by_class(self) -> pl.LazyFrame:
        ...
        Columns: exposure_class, exposure_count, total_ead, total_rwa,
        avg_risk_weight, floor_binding_count.
        """
    ...
    def generate_summary_by_approach(self) -> pl.LazyFrame:
        ...
        Columns: approach_applied, exposure_count, total_ead, total_rwa,
        total_floor_impact, total_expected_loss.
        """

    def generate_supporting_factor_impact(self) -> pl.LazyFrame:
        """Generate supporting factor impact analysis (filtered to factor < 1.0)."""
```
