...
Published 2026-05-19. Code references are pinned to commit [`cceaee4`](https://github.com/OpenAfterHours/rwa_calculator/tree/cceaee4).
...
**Read next:** [*The Output Floor and Why Basel 3.1 Bites*](2026-05-26-the-output-floor-and-why-basel-31-bites.md).
