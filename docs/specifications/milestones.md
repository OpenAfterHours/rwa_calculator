...
| Milestone | Description | Status |
|-----------|-------------|--------|
| M3.1 | Side-by-side CRR vs Basel 3.1 RWA comparison | Not Started |
| M3.2 | Capital impact analysis (delta RWA) | Not Started |
| M3.3 | Transitional floor schedule modelling | Not Started |
