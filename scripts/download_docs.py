...
BOE_PS126_BASE = (
    ...
    "/prudential-regulation/policy-statement/2026/january"
)
BOE_PS126_LANDING = (
    "https://www.bankofengland.co.uk/prudential-regulation"
    "/publication/2026/january"
    "/implementation-of-the-basel-3-1-final-rules-policy-statement"
)
...
MANIFEST: list[DocEntry] = [
    ...
    DocEntry(
        filename="ps1-26-annex-ii-output-floor-and-capital-summaries-disclosure-instructions.pdf",
        description="Basel 3.1 output floor and capital summaries disclosure instructions",
        url=None,
        source=BOE_PS126_LANDING,
    ),
    DocEntry(
        filename="ps1-26-annex-xx-credit-risk-sa-disclosure-instructions.pdf",
        description="Basel 3.1 credit risk SA disclosure instructions",
        url=None,
        source=BOE_PS126_LANDING,
    ),
    DocEntry(
        filename="ps1-26-annex-xxii-credit-risk-irb-disclosure-instructions.pdf",
        description="Basel 3.1 credit risk IRB disclosure instructions",
        url=None,
        source=BOE_PS126_LANDING,
    ),
    DocEntry(
        filename="ps1-26-annex-xxiv-credit-risk-irb-disclosure-instructions.pdf",
        description="Basel 3.1 credit risk IRB additional disclosure instructions",
        url=None,
        source=BOE_PS126_LANDING,
    ),
    # --- CRR documents (manual download from PRA Rulebook / EBA) ---
    DocEntry(
