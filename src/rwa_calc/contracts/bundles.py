    ...
    return CounterpartyLookup(
        ...
        rating_inheritance=pl.LazyFrame(
            schema={
                ...
                "internal_rating_date": pl.Date,
                "internal_inherited": pl.Boolean,
                "internal_source_counterparty": pl.String,
                "internal_inheritance_reason": pl.String,
                "external_cqs": pl.Int8,
                "external_rating_value": pl.String,
                "external_rating_agency": pl.String,
                "external_rating_date": pl.Date,
                "external_inherited": pl.Boolean,
                "external_source_counterparty": pl.String,
                "external_inheritance_reason": pl.String,
                "cqs": pl.Int8,
                "pd": pl.Float64,
