...
def print_summary(saved: dict[str, Path]) -> None:
    ...
    print()
    print(f"  Arm A (P194D_REVOLVING, is_revolving=True, partially drawn):")
    ...
    print(f"    waiver                               = True  (full draw = current draw)")
