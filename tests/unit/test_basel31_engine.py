...
class TestPDFloors:
    ...
    def test_crr_uniform_floor_corporate(
        ...
        result = lf.with_columns(
            _pd_floor_expression(crr_config).alias("pd_floor")
        ).collect()
    ...
    def test_crr_uniform_floor_all_classes_equal(
        ...
        classes = [
            "CORPORATE", "CORPORATE_SME", "RETAIL_MORTGAGE",
            "RETAIL_QRRE", "RETAIL_OTHER", "INSTITUTION",
        ]
        lf = pl.LazyFrame({
    ...
    def test_basel31_corporate_floor(
        ...
        result = lf.with_columns(
            _pd_floor_expression(basel31_config).alias("pd_floor")
        ).collect()
    ...
    def test_multiple_classes_differentiated_floors(
        ...
        lf = pl.LazyFrame({
            "exposure_class": [
                "CORPORATE", "RETAIL_QRRE", "RETAIL_MORTGAGE",
            ],
...
class TestLGDFloors:
    ...
    def test_crr_lgd_floor_is_zero(
        ...
        result = lf.with_columns(
            _lgd_floor_expression(crr_config).alias("lgd_floor")
        ).collect()
    ...
    def test_crr_lgd_floor_with_collateral_is_zero(
        ...
        result = lf.with_columns(
            _lgd_floor_expression_with_collateral(crr_config).alias(
                "lgd_floor"
            )
        ).collect()
        assert result["lgd_floor"][0] == pytest.approx(0.0)
    ...
    def test_basel31_unsecured_floor_25pct(
        ...
        lf = pl.LazyFrame({"lgd": [0.10]})
        result = lf.with_columns(
            _lgd_floor_expression(basel31_config).alias("lgd_floor")
        ).collect()
    ...
    def test_multiple_collateral_types_floors(
        ...
        lf = pl.LazyFrame({
            ...
            "collateral_type": [
                "financial", "receivables", "residential_re",
        ...
        for i, (coll_type, exp_floor) in enumerate(
            ...
            assert result["lgd_floor"][i] == pytest.approx(
                exp_floor
...
class TestFIRBSupervisoryLGD:
    ...
    def test_basel31_senior_unsecured_lgd(self) -> None:
        ...
        assert BASEL31_FIRB_SUPERVISORY_LGD["unsecured_senior"] == Decimal(
            "0.40"
        )
    ...
    def test_basel31_financial_collateral_lgd(self) -> None:
        ...
        assert BASEL31_FIRB_SUPERVISORY_LGD[
    ...
    def test_basel31_residential_re_lgd(self) -> None:
        ...
        assert BASEL31_FIRB_SUPERVISORY_LGD["residential_re"] == Decimal(
            "0.20"
        )
    ...
    def test_basel31_other_physical_lgd(self) -> None:
        ...
        assert BASEL31_FIRB_SUPERVISORY_LGD["other_physical"] == Decimal(
            "0.25"
        )
    ...
    def test_lookup_crr_unsecured_senior(self) -> None:
        ...
        result = lookup_firb_lgd(
            collateral_type=None, is_subordinated=False, is_basel_3_1=False,
        )
    ...
    def test_lookup_basel31_unsecured_senior(self) -> None:
        ...
        result = lookup_firb_lgd(
            collateral_type=None, is_subordinated=False, is_basel_3_1=True,
        )
...
class TestCCFBasel31:
    ...
    def test_sa_ccf_fr_unchanged(self) -> None:
        ...
        crr_result = lf.with_columns(
            sa_ccf_expression(is_basel_3_1=False).alias("ccf")
        ).collect()
        b31_result = lf.with_columns(
            sa_ccf_expression(is_basel_3_1=True).alias("ccf")
        ).collect()
...
class TestEquityBasel31:
    ...
    def test_crr_sa_only_returns_sa(
        self, crr_sa_only_config: CalculationConfig,
    ) -> None:
    ...
    def test_basel31_sa_only_returns_sa(
        self, basel31_sa_only_config: CalculationConfig,
    ) -> None:
