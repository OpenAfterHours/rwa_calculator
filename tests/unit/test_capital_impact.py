...
def _make_crr_results(
    ...
    data: dict = {
        ...
        "reporting_class": exposure_classes,
        "reporting_approach": approaches,
...
def _make_b31_results(
    ...
    data: dict = {
        ...
        "reporting_class": ["corporate"] * len(exposure_refs),
        "reporting_approach": ["foundation_irb"] * len(exposure_refs),
        "ead_final": [1_000_000.0] * len(exposure_refs),
        "risk_weight": [0.5] * len(exposure_refs),
        "rwa_final": rwa_finals,
    }
