        ...
        results=pl.LazyFrame(
            {
                ...
                "reporting_class": ["corporate", "retail_mortgage", "institution"],
                "reporting_approach": ["SA", "SA", "SA"],
                "reporting_method": ["STD", "STD", "STD"],
            ...
            results=pl.LazyFrame(
                {
                    ...
                    "approach_applied": ["SA"],
                    "reporting_class": ["corporate"],
                    "reporting_approach": ["SA"],
                    "reporting_method": ["STD"],
            ...
            results=pl.LazyFrame(
                {
                    ...
                    "reporting_class": ["corporate", "corporate"],
                    "reporting_approach": ["SA", "SA"],
            ...
            results=pl.LazyFrame(
                {
                    ...
                    "approach_applied": ["SA", "SA"],
                    "reporting_class": ["corporate", "institution"],
                    "reporting_approach": ["SA", "SA"],
                    "reporting_method": ["STD", "STD"],
