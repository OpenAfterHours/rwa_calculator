...
def _(ScenarioResult):
    ...
    group_a = [
        ...
        ScenarioResult(
            "A5",
            "A",
            "Residential mortgage 60% LTV - 20% RW",
            "LOAN_RTL_MTG_001",
            "RTL_MTG_001",
            "SA",
            "RETAIL_MORTGAGE",
        ...
        ScenarioResult(
            "A6",
            "A",
            "Residential mortgage 85% LTV - 35% RW",
            "LOAN_RTL_MTG_002",
            "RTL_MTG_002",
            "SA",
            "RETAIL_MORTGAGE",
        ...
        ScenarioResult(
            ...
            1.00,
            400000,
            {"ccf": 0.40, "nominal": 1000000},
            "CRE20.96",
        ),
        ScenarioResult(
            "A9",
            "A",
            "Retail exposure - 75% RW",
            "LOAN_RTL_IND_001",
            "RTL_IND_001",
            "SA",
            "RETAIL",
    ...
    group_b = [
        ...
        ScenarioResult(
            "B2",
            "B",
            "Corporate with financial collateral",
            "LOAN_FIRB_CORP_002",
            "CORP_FIRB_002",
            "FIRB",
            "CORPORATE",
    ...
    group_c = [
        ...
        ScenarioResult(
            ...
            0.4573,
            457300,
            {"lgd_raw": 0.05, "lgd_floor": 0.25},
            "CRE32.20",
        ),
        ScenarioResult(
            "C3",
            "C",
            "Retail own estimates",
            "LOAN_AIRB_RTL_001",
            "RTL_AIRB_001",
            "AIRB",
            "RETAIL",
    ...
    group_d = [
        ScenarioResult(
            ...
            1.00,
            500000,
            {"collateral": 500000, "haircut": 0},
            "CRE22.52",
        ),
        ScenarioResult(
            "D2",
            "D",
            "Govt bond collateral",
            "LOAN_CRM_D2_001",
            "CORP_CRM_D2_001",
            "SA",
            "CORPORATE",
            ...
            1.00,
            412000,
            {"collateral": 600000, "haircut": 0.02},
            "CRE22.52-53",
        ),
        ScenarioResult(
            "D3",
            ...
            1.00,
            700000,
            {"collateral": 400000, "haircut": 0.25},
            "CRE22.52",
        ),
        ScenarioResult(
            "D4",
            ...
            0.52,
            520000,
            {"guarantee": 600000, "guarantor_rw": 0.20},
            "CRE22.70-71",
        ),
        ScenarioResult(
            "D5",
    ...
    group_f = [
        ScenarioResult(
            ...
            0,
            72500000,
            {"irb_rwa": 50000000, "sa_rwa": 100000000, "floor_pct": 0.725},
            "CRE99",
        ),
        ScenarioResult(
            "F2",
            "F",
            "Output floor not binding",
            "PORTFOLIO_IRB_002",
            "PORTFOLIO",
            "IRB",
            "PORTFOLIO",
            ...
            0,
            80000000,
            {"irb_rwa": 80000000, "sa_rwa": 100000000, "floor_pct": 0.725},
            "CRE99",
        ),
        ScenarioResult(
            "F3",
            "F",
            "Transitional floor 2027",
            "PORTFOLIO_IRB_003",
            "PORTFOLIO",
            "IRB",
            "PORTFOLIO",
            ...
            0,
            60000000,
            {"irb_rwa": 50000000, "sa_rwa": 100000000, "floor_pct": 0.60},
            "CRE99",
        ),
    ]
    ...
    group_g = [
        ...
        ScenarioResult(
            ...
            0.8234,
            823400,
            {"el": 4500, "provision": 10000},
            "CRE35.1-3",
        ),
        ScenarioResult(
            "G3",
            "G",
            "IRB Stage 3 defaulted",
            "LOAN_PROV_G3_001",
            "CORP_DF_PROV_001",
            "FIRB",
            "DEFAULTED",
    ...
    group_h = [
        ...
        ScenarioResult(
            ...
            0.3555,
            7110000,
            {"sa_rwa": 6500000, "irb_rwa": 4100000},
            "CRR Art 150",
        ),
        ScenarioResult(
            "H4",
            ...
            0.2889,
            5200000,
            {"collateral": 10000000, "guarantee": 15000000, "provision": 1000000},
            "CRE22",
        ),
    ]
